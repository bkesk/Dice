...
python3 ../test_energy.py  1.0e-5
python3 ../test_twopdm.py spatialRDM.0.0.txt trusted2RDM.txt 1.e-8

cd $here/o2_det
printf "...running o2_det\n"
$MPICOMMAND $HCIPATH > output.dat
python3 ../test_energy.py  1.0e-6
...
python3 $here/test_energy.py 5e-5
...
python3 $here/test_energy.py 5e-5 e_spin_0.e
$MPICOMMAND $HCIPATH input2.dat > output2.dat
python3 $here/test_energy.py 5e-5 e_spin_2.e
$MPICOMMAND $HCIPATH input3.dat > output3.dat
python3 $here/test_energy.py 5e-5 e_spin_1.e
$MPICOMMAND $HCIPATH input4.dat > output4.dat
python3 $here/test_energy.py 5e-5 e_spin_3.e

cd $here/spin1rdm
printf "...running spin1RDM tests\n"
$HCIPATH input.dat > output.dat
python3 $here/test_spin1RDM.py spin1RDM.0.0.txt spatial1RDM.0.0.txt 1e-8
...
$HCIPATH input.dat > output.dat
python3 $here/test_onepdm.py spatial1RDM.0.0.txt pyscf_1RDM.npy 1.e-9
python3 $here/test_twopdm.py spatialRDM.0.0.txt pyscf_2RDM.npy 1.e-9
python3 $here/test_threepdm.py spatial3RDM.0.0.txt pyscf_3RDM.npy 1.e-9
python3 $here/test_spin1RDM.py spin1RDM.0.0.txt spatial1RDM.0.0.txt 1e-9
python3 $here/test_rdm_nelec.py ../integrals/H2H2_FCIDUMP_nosym spatial1RDM.0.0.txt spatialRDM.0.0.txt spatial3RDM.0.0.txt 5e-8

cd $here/h2o_trev_direct_rdm
printf "...running H2O Trev Direct RDM Test\n"
$HCIPATH test_input.dat > output.dat
python3 $here/test_twopdm.py spatialRDM.0.0.txt pyscf_2RDM.npy 2.e-8

cd $here/h2co_rdm
printf "...running H2CO RDM Test\n"
$HCIPATH test_input.dat > output.dat
python3 $here/test_onepdm.py spatial1RDM.0.0.txt pyscf_1RDM.npy 1e-8
python3 $here/test_twopdm.py spatialRDM.0.0.txt pyscf_2RDM.npy 1e-9
python3 $here/test_threepdm.py spatial3RDM.0.0.txt pyscf_3RDM.npy 1e-10
python3 $here/test_rdm_nelec.py ../integrals/h2co_FCIDUMP_nosymm spatial1RDM.0.0.txt spatialRDM.0.0.txt spatial3RDM.0.0.txt 1e-11
...
$MPICOMMAND $HCIPATH > output.dat
python3 ../test_energy.py 8.0e-5
python3 ../test_twopdm.py spatialRDM.0.0.txt trusted2RDM.txt 1.e-9
